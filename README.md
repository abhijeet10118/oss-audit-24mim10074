...
I’m **Vedang** (`Vedang`, reg no `24MIM10074`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
From the repo directory (`https://github.com/Abhijeetanand75-crypto/LINUX/tree/main`):
